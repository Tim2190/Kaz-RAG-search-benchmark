...
# ─── FERTILITY (обязательно перед пингом Jina) ───────────────────────────────
#
# НУЖНО ЗАПУСТИТЬ ДО ПИНГА команды Jina: без этого числа пинговать нельзя.
# Нужен N× — во сколько раз Jina дробит казахский сильнее e5-base.
# Скопируй строки "e5-base" и "jina-v3" из вывода — вставим в findings/jina-v3.md.
...
#
# Из вывода tokenization_test нужно:
#   e5-base    X.XX  X.XX      (без пробела / с пробелом)
#   jina-v3    X.XX  X.XX
# N = jina_bare / e5_bare  (округлить до 1 знака)
